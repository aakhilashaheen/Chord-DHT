...
public class SuperNode {
  ...
  public interface AsyncIface {
    ...
    public void join(String hostname, int port, AsyncMethodCallback resultHandler) throws TException;

    public void postJoin(String hostname, int port, AsyncMethodCallback resultHandler) throws TException;

    public void getNode(AsyncMethodCallback resultHandler) throws TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_join(String hostname, int port) throws TException
    {
    ...
    public void send_postJoin(String hostname, int port) throws TException
    {
    ...
    public String recv_postJoin() throws TException
    {
    ...
    public void send_getNode() throws TException
    {
      getNode_args args = new getNode_args();
      sendBase("getNode", args);
    }

    public String recv_getNode() throws TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class join_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private int port;
      public join_call(String hostname, int port, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
    ...
    public static class postJoin_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String hostname;
      private int port;
      public postJoin_call(String hostname, int port, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.hostname = hostname;
        this.port = port;
      }
    ...
    public static class getNode_call extends org.apache.thrift.async.TAsyncMethodCall {
      public getNode_call(AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class postJoin<I extends Iface> extends org.apache.thrift.ProcessFunction<I, postJoin_args> {
      ...
      public postJoin_result getResult(I iface, postJoin_args args) throws TException {
        postJoin_result result = new postJoin_result();
    ...
    public static class getNode<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getNode_args> {
      ...
      public getNode_result getResult(I iface, getNode_args args) throws TException {
        getNode_result result = new getNode_result();
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class postJoin<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, postJoin_args, String> {
      ...
      public void start(I iface, postJoin_args args, AsyncMethodCallback<String> resultHandler) throws TException {
    ...
    public static class getNode<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getNode_args, String> {
      ...
      public void start(I iface, getNode_args args, AsyncMethodCallback<String> resultHandler) throws TException {
  ...
  public static class postJoin_args implements org.apache.thrift.TBase<postJoin_args, postJoin_args._Fields>, java.io.Serializable, Cloneable, Comparable<postJoin_args>   {
    ...
    private static class postJoin_argsStandardScheme extends StandardScheme<postJoin_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, postJoin_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, postJoin_args struct) throws TException {
        struct.validate();
    ...
    private static class postJoin_argsTupleScheme extends TupleScheme<postJoin_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, postJoin_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetHostname()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, postJoin_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(2);
        if (incoming.get(0)) {
          struct.hostname = iprot.readString();
  ...
  public static class postJoin_result implements org.apache.thrift.TBase<postJoin_result, postJoin_result._Fields>, java.io.Serializable, Cloneable, Comparable<postJoin_result>   {
    ...
    private static class postJoin_resultStandardScheme extends StandardScheme<postJoin_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, postJoin_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, postJoin_result struct) throws TException {
        struct.validate();
    ...
    private static class postJoin_resultTupleScheme extends TupleScheme<postJoin_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, postJoin_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, postJoin_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = iprot.readString();
...
;
    ...
    private static class getNode_argsStandardScheme extends StandardScheme<getNode_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getNode_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getNode_args struct) throws TException {
        struct.validate();
    ...
    private static class getNode_argsTupleScheme extends TupleScheme<getNode_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getNode_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
      }

      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getNode_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
      }
    }
  ...
  public static class getNode_result implements org.apache.thrift.TBase<getNode_result, getNode_result._Fields>, java.io.Serializable, Cloneable, Comparable<getNode_result>   {
    ...
    private static class getNode_resultStandardScheme extends StandardScheme<getNode_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getNode_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getNode_result struct) throws TException {
        struct.validate();
    ...
    private static class getNode_resultTupleScheme extends TupleScheme<getNode_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getNode_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getNode_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = iprot.readString();
